...
function Node(parser, elem, attrs, prefix, eventHandler, parent) {
	var
		attrNode,
		attrName,
		attrValue,
	...
	this.prefix = String(prefix ? prefix.toLowerCase() : '');
	this.type = CONST.TYPE_ELEMENT_NODE;
	this.attributes = {};
	this.children = [];
	this.parent = parent;
	this.index = parent.children.length;
	this.namespaces = Object.create(parent.namespaces);
	this.code = '';
	...
	if (this.namespace === CONST.NS && API.hasOwnProperty(this.name)) {
