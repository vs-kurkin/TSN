...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td></td>
			<td>
				<div><b>js</b>: подготавливает данные, предназначенные для вставки в JavaScript-строку.</div>
				<div><b>decAll</b>: заменяет все символы, кроме `a-z 0-9 - _ .` на десятиричные HTML-коды.</div>
				<div><b>decHtml</b>: заменяет символы `&amp;&lt;&gt;&quot;'` на десятиричные HTML-коды.</div>
				<div><b>hexAll</b>: заменяет все символы, кроме `a-z 0-9 - _ .` на шестнадцатеричные HTML-коды.</div>
				<div><b>hexHtml</b>: заменяет символы `&amp;&lt;&gt;&quot;'` на шестнадцатеричные HTML-коды.</div>
				<div><b>hexUrl</b>: кодирует URL-строку функцией encodeURI.</div>
				<div><b>hexUrlAll</b>: кодирует URL-строку функцией encodeURIComponent.</div>
			</td>
			<td>нет</td>
