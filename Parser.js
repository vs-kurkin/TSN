...
/**
 * @name TSN.config.inheritConfig
 * @description Флаг, указывающий на необходимость наследования кастомного объекта конфигурации {@link TSN.config}. Если значение параметра true - значением по-умолчанию атрибута <i>config</i> тега <i>render</i> будет конфиг текущего шаблона.
 * @default true
 * @type boolean
 */